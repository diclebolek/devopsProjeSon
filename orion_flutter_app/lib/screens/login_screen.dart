...
class _LoginScreenState extends State<LoginScreen>
                                        ...
                                        children: [
                                          ...
                                          FadeTransition(
                                            ...
                                            child: SlideTransition(
                                              ...
                                              child: Text(
                                                "${lang.t('welcome_to')} ${_isletme?['isim'] ?? 'Orion'}",
                                                style: TextStyle(
                                                  color: _isDarkMode
                                                      ? Colors.white
                                          ...
                                          FadeTransition(
                                            ...
                                            child: SlideTransition(
                                              ...
                                              child: Text(
                                                "${lang.t('sign_in_to_your')} ${_isletme?['isim'] ?? 'Orion'} ${lang.t('account')}",
                                                style: TextStyle(
                                                  color: _isDarkMode
                                                      ? Colors.white
                                                      : SiriusColors
                                          ...
                                          FadeTransition(
                                            ...
                                            child: SlideTransition(
                                              ...
                                              child: TextFormField(
                                                ...
                                                validator: (value) {
                                                  // Boş bırakılabilir: bilgi girilmeden
                                                  // Sign In şifresiz girişi başlatır.
                                                  if (value == null ||
                                                      value.isEmpty) {
                                                    return null;
                                                  }
                                          ...
                                          FadeTransition(
                                            ...
                                            child: SlideTransition(
                                              ...
                                              child: TextFormField(
                                                ...
                                                validator: (value) {
                                                  // Şifre boş bırakılabilir: "Şifresiz Giriş" akışı için.
                                                  if (value == null ||
                                                      value.isEmpty) {
                                                    return null;
                                                  }
  ...
  void _performLogin() async {
    // Şifre boşsa doğrulama yapmadan şifresiz giriş akışına düş.
    if (_passwordController.text.isEmpty) {
      _performPasswordlessLogin();
      return;
    }
